...
small_df <- read_sf(here("result","ca_county_power_disruption_less_12hrs.shp"))

big_df <- read_sf(here("result","ca_county_power_disruption_more_12hrs.shp"))
...
```{r}
ggsave(
  here("plot", "01_bivariate_map_12hrs_cutoff.png"),
...
```{r}
ggsave(
  here("plot", "01_bivariate_map_12hrs_cutoff_1col.png"),
