...
```{r}
st_write(small_outage_shp, here("result","ca_county_power_disruption_less_12hrs.shp"), 
         delete_layer = TRUE)

st_write(big_outage_shp, here("result","ca_county_power_disruption_more_12hrs.shp"), 
         delete_layer = TRUE)
```